class repeated_task {
  ...
  repeated_task({this.icon, this.id, this.title, this.days, this.creator, this.alert_time, this.assignee, this.shared, this.repeated, this.finished, this.finished_by, this.belongs_to});
